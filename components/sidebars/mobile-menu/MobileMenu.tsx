...
const MobileMenu = () => {
  ...
  const renderLinks = () => {
    return token ? (
      <>
        <li>
          <Link href="/profile/2" title="My Account" onClick={() => setOpenMobailMenu(false)}>
        ...
        <li>
          <Link href="/cart" title="Shopping Cart" onClick={() => setOpenMobailMenu(false)}>
            <span className="utilize-btn-icon">
              <ShoppingCart />
              <sup>5</sup>
            </span>
    ...
    >
      <div className="ltn__utilize-menu-inner ltn__scrollbar">
        <div className="ltn__utilize-menu-head">
          ...
          <button className="ltn__utilize-close" onClick={() => setOpenMobailMenu(false)}>
            ×
          </button>
        </div>
        ...
        <div className="ltn__utilize-menu">
          <ul>
            ...
            <li>
                <Link href="/products" onClick={() => setOpenMobailMenu(false)}>Products</Link>
            </li>
            <li>
              <Link href="/promotions" onClick={() => setOpenMobailMenu(false)}>
                Promotions
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/privacy-policy" onClick={() => setOpenMobailMenu(false)}>
                Privacy Policy
              </Link>
            </li>
            <li>
              <Link href="/terms-conditions" onClick={() => setOpenMobailMenu(false)}>
                Terms & Conditions
              </Link>
            </li>
          </ul>
